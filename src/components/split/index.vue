<template>
  <div :class="classes" ref="splitOuter">
    ...
    <div class="pane pane-trigger" :style="{ left: triggerLeft, width: `${triggerWidth}px` }" @mousedown="mousedownClick">
      <span>-</span>
      <span>-</span>
      <span>-</span>
      <span>-</span>
...
export default {
  ...
  methods: {
    ...
    mousemoveHandleClick(e) {
      ...
      const currentLeft = (e.pageX - outerLeft + this.triggerWidth / 2) / outerWidth;
